...
// Do not change the following definitions
  #define GG_UMOD_DEVICE "ESP32"                 			 // Set your hardware here
  #define GG_HARDWARE_VERSION "1.0"              			 // Set your hardware version here
  #define GG_UMOD_BME680X_SW_VERSION "1.0.3"     			 // Version of the User Mod
  #define GG_CALIB_FILE_NAME "/BME680X-Calib.hex"			 // Calibration file name
  #define GG_UMOD_NAME "BME680X"                 			 // User module name
  #define GG_UMOD_DEBUG_NAME "UM-BME680X: "      			 // Debug print module name 
  #define GG_ESC "\033"
